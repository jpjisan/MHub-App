...
function MovieDetails() {
  ...
  return !info ? (
    ...
    <div
      className="m-h-screen relative w-screen md:px-18 px-2 py-2"
      style={{
        background: `
      linear-gradient(
        180deg,
    ...
    >
      ...
      {/* poster and details */}
      <div className="flex flex-col   md:flex-row md:gap-20 gap-5 w-full ">
        <div className=" md:w-[30%] w-full flex md:flex-col gap-2  justify-center      ">
          <img
            className=" md:w-full md:h-[60vh] w-[50%] h-[40vh] object-cover rounded-lg shadow-[8px_17px_38px_2px_rgba(0,0,0,.8)]"
            src={
              info.details.poster_path ||
              info.details.backdrop_path ||
              info.details.profile_path ||
